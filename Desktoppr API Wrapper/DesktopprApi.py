...
class DesktopprApi(object):
    ...
    def follow_user(self,username,unfollow=False):
        ...
        if unfollow==False:
            print('Following')
            print(self.baseurl+'users/'+username+'/follow')
            #,params={'auth_token': self.apikey})
            r = requests.post(self.baseurl+'users/'+username+'/follow',params={'auth_token': self.apikey})
    ...
    def check_if_synced(self,wallpaper_id):
        pass
    
    def flag_wallpaper(self,flag):
        '''flag is flag_safe, flag_not_safe, and flag_deletion'''
        pass
